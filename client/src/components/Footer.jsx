    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">HireScape</h3>
            <p className="text-sm mb-4">
              Connecting professionals with opportunities. Making job management simple and efficient.
            </p>
            <div className="space-y-2">
              <div className="flex items-center">
                <Mail className="h-5 w-5 mr-2" />
                <span className="text-sm">hirescape01@gmail.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="h-5 w-5 mr-2" />
                <span className="text-sm">+234 808 091 0750</span>
              </div>
              <div className="flex items-center">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="text-center text-sm">
            <p>&copy; {new Date().getFullYear()} HireScape. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
